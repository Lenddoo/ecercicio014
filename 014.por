/*
Número Inteiro
Este exemplo pede ao usuário que informe um número inteiro. logo após, exibe um mensagem
indicando se número informado é positivo, negativo ou igual azero.
*/
